...
namespace courseworkv5.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentId,DepartmentName,Salary")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentId,DepartmentName,Salary")] Departments departments)
        {
            if (ModelState.IsValid)
            {
